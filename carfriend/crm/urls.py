...
urlpatterns = [
    ...
    path('crm/retail/ocb/<int:ocb_id>/declare/',       retail.retail_ocb_declare,      name='retail_ocb_declare'),
    ...
    path('crm/retail-head/ocb-tracking/',   rh.rh_ocb_tracking,    name='rh_ocb_tracking'),
