...
urlpatterns = [
    ...
    path("inspect/<int:id>/photo", v.insp_cp_photo, name="insp_cp_photo"),
    path("inspect/photo/<int:media_id>/delete", v.insp_cp_photo_delete, name="insp_cp_photo_delete"),
    path("inspect/<int:id>/registry/fetch", v.insp_registry_fetch, name="insp_registry_fetch"),
    path("inspect/<int:id>/registry/ocr", v.insp_registry_ocr, name="insp_registry_ocr"),
    path("inspect/<int:id>/hero", v.insp_hero_upload, name="insp_hero_upload"),
